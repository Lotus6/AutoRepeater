...
public class Replacements {
    ...
    private JButton clearReplacementButton;
    ...
    private void createUI() {
        ...
        clearReplacementButton = new JButton("Clear");
        clearReplacementButton.setPreferredSize(AutoRepeater.buttonDimension);
        clearReplacementButton.setMinimumSize(AutoRepeater.buttonDimension);
        clearReplacementButton.setMaximumSize(AutoRepeater.buttonDimension);

        // Duplicate a replacement
        clearReplacementButton.addActionListener(e -> {
            for (int i = 0; i <  replacementTableModel.getReplacements().size(); i++) {
                replacementTableModel.deleteReplacement(i);
            }
            replacementTableModel.fireTableDataChanged();
        });
        ...
        replacementsButtonPanel.add(clearReplacementButton, c);
